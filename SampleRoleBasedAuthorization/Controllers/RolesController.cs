...
namespace SampleRoleBasedAuthorization.Controllers
{
    public class RolesController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Role roles)
        {
        ...
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] Role roles)
        {
            if (id != roles.Id)
            {
                return NotFound();
        ...
        public IActionResult Update(int id, List<int> roles)
        {
            ...
            {
                _context.LinkRolesMenus.Add(new LinkRolesMenu { MenusId = role, RolesId = id });
            }
